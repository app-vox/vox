        ...
        {!displayCollapsed && (
          <div className={card.body}>
            ...
            <label className={`${styles.checkboxRow} ${!setupComplete ? styles.disabled : ""}`}>
              <input
                type="checkbox"
                checked={config.alwaysShowPreview ?? true}
                disabled={!setupComplete}
                onChange={async () => {
                  updateConfig({ alwaysShowPreview: !config.alwaysShowPreview });
                  await saveConfig(false);
                  triggerToast();
                }}
              />
              <div>
                <div className={styles.checkboxLabel}>{t("general.hud.alwaysShowPreview")}</div>
                <div className={styles.checkboxDesc}>{t("general.hud.alwaysShowPreviewDesc")}</div>
                <div className={styles.checkboxDesc}>
                  ...
                  {t("general.hud.alwaysShowPreviewNote")}
                </div>
              </div>
            </label>

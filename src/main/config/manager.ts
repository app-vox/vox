    ...
    if (!fs.existsSync(this.configPath)) {
      ...
      try {
        ...
        config = {
          ...
          alwaysShowPreview: saved.alwaysShowPreview ?? defaults.alwaysShowPreview,
          ttsEnabled: saved.ttsEnabled ?? defaults.ttsEnabled,
          ttsConnectionTested: saved.ttsConnectionTested ?? defaults.ttsConnectionTested,
          ttsConfigHash: saved.ttsConfigHash ?? defaults.ttsConfigHash,
